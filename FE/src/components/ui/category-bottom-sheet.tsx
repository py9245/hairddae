  ...
  return (
    ...
    >
      <div className="relative">
        <div className="relative mb-[94px] max-h-[calc(100dvh-6.5rem)] overflow-y-auto rounded-[32px] border border-white/70 bg-[#fffaf7] px-5 pb-5 pt-4 shadow-[0_-18px_40px_rgba(47,47,47,0.16)]">
