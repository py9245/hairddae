...
} from '@/runtime/asset-runtime'
import type { UserFeatureMessage } from '@/contracts/websocket'
import {
  type BuildUserFeaturePayloadArgs,
  buildUserFeaturePayload,
} from '@/feature/extract-user-feature'
import {
...
export type UseHairRecommendFlowArgs = {
...
export function useHairRecommendFlow({
  recommendBaseUrl = '/api/hairs/recommend',
  fetchImpl = fetch,
